...
using SeleniumExample.TestProject.Constants;
...
namespace SeleniumExample.TestProject
{
    ...
    public class BaseTest
    {
        ...
        public virtual void OneTimeSetUp()
        {
            ...
            var reporter = (new ExtentHtmlReporter(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "..\\..\\..\\..\\..\\..\\Reports\\Report " + DateTime.Now.ToString("yyyyMMdd-hms").Replace('/', ' ') + DriverType.ToString() + "\\ExtentReport.html"));
